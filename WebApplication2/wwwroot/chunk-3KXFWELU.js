...
var ChatService = class _ChatService {
  ...
  connectionStatus = signal("Disconnected", ...ngDevMode ? [{ debugName: "connectionStatus" }] : (
    /* istanbul ignore next */
    []
  ));
  ...
  connect() {
    ...
    this.connection = new HubConnectionBuilder().withUrl("/chatHub", {
  ...
  setupSignalRHandlers() {
    ...
    this.connection.on("AssistantChunk", ({ responseId, text }) => {
      this.messages.update((ms) => ms.map((m) => m.responseId === responseId ? __spreadProps(__spreadValues({}, m), { content: m.content + text }) : m));
    });
    this.connection.on("AssistantCompleted", ({ responseId }) => {
      this.messages.update((ms) => ms.map((m) => m.responseId === responseId ? __spreadProps(__spreadValues({}, m), { responseId: void 0 }) : m));
      this.isSending.set(false);
    });
    this.connection.on("AssistantError", ({ responseId, error }) => {
      this.messages.update((ms) => ms.map((m) => m.responseId === responseId ? __spreadProps(__spreadValues({}, m), { kind: "error", content: error, responseId: void 0 }) : m));
      this.isSending.set(false);
    });
  ...
  async startConnection() {
    ...
    try {
      ...
      setTimeout(() => this.startConnection(), 2e3);
    }
  }
  async sendMessage(html, text) {
    if (!text.trim() || !this.connection || this.connection.state !== HubConnectionState.Connected)
      return;
...
var UserService = class _UserService {
  ...
  userInfoSignal = signal(null, ...ngDevMode ? [{ debugName: "userInfoSignal" }] : (
    /* istanbul ignore next */
    []
  ));
  userInfo = computed(() => this.userInfoSignal() ?? this.auth.user(), ...ngDevMode ? [{ debugName: "userInfo" }] : (
    /* istanbul ignore next */
    []
  ));
  userName = computed(() => this.userInfo()?.displayName || this.userInfo()?.username || "Anonymous", ...ngDevMode ? [{ debugName: "userName" }] : (
    /* istanbul ignore next */
    []
  ));
  isAuthenticated = computed(() => this.auth.isAuthenticated(), ...ngDevMode ? [{ debugName: "isAuthenticated" }] : (
    /* istanbul ignore next */
    []
  ));
  constructor() {
...
function HeaderComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function HeaderComponent_div_7_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function HeaderComponent_div_7_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.getInitials(ctx_r1.userName()));
    \u0275\u0275advance(2);
...
function HeaderComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6)(1, "span", 14);
    \u0275\u0275text(2, "Guest");
    \u0275\u0275elementEnd()();
  }
}
var HeaderComponent = class _HeaderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], decls: 9, vars: 2, consts: [[1, "app-header"], [1, "header-content"], [1, "logo-section"], [1, "logo-icon"], [1, "app-title"], ["class", "user-section", 4, "ngIf"], [1, "user-section"], [1, "user-info"], [1, "user-avatar"], [1, "user-name"], ["type", "button", "title", "Refresh user info", "aria-label", "Refresh user info", 1, "refresh-button", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "height", "20", "viewBox", "0 -960 960 960", "width", "20", "fill", "currentColor"], ["d", "M480-160q-134 0-227-93t-93-227q0-134 93-227t227-93q69 0 132 28.5T720-690v-110h80v280H520v-80h168q-37-56-93.5-88T480-720q-100 0-170 70t-70 170q0 100 70 170t170 70q81 0 145.5-47T714-420l62 46q-38 64-101.5 105T480-160Z"], ["type", "button", "title", "Sign out", "aria-label", "Sign out", 1, "logout-button", 3, "click"], [1, "guest-label"]], template: function HeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "AI Chat");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(7, HeaderComponent_div_7_Template, 11, 2, "div", 5)(8, HeaderComponent_div_8_Template, 3, 0, "div", 5);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
...
function ChatComponent_article_13_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 19);
  }
  if (rf & 2) {
    const msg_r1 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("innerHTML", msg_r1.content, \u0275\u0275sanitizeHtml);
  }
}
function ChatComponent_article_13_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function ChatComponent_article_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article")(1, "div", 16);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, ChatComponent_article_13_div_3_Template, 1, 1, "div", 17)(4, ChatComponent_article_13_div_4_Template, 2, 1, "div", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const msg_r1 = ctx.$implicit;
    \u0275\u0275classMap("message " + msg_r1.kind);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(msg_r1.kind.startsWith("user") ? "YOU" : "AI");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", msg_r1.isHtml);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !msg_r1.isHtml);
  }
}
var ChatComponent = class _ChatComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatComponent, selectors: [["app-chat"]], viewQuery: function ChatComponent_Query(rf, ctx) {
  ...
  }, decls: 30, vars: 3, consts: [["messagesContainer", ""], ["editor", ""], [1, "app-shell"], ["aria-label", "AI chat", 1, "chat-panel"], [1, "chat-header"], ["type", "button", 1, "ghost-button", 3, "click"], ["aria-live", "polite", 1, "messages"], [3, "class", 4, "ngFor", "ngForOf"], [1, "composer-container", 3, "submit"], [1, "toolbar"], ["type", "button", "title", "Bold", 3, "click"], ["type", "button", "title", "Italic", 3, "click"], ["type", "button", "title", "Underline", 3, "click"], [1, "composer"], ["contenteditable", "true", "role", "textbox", "aria-label", "Message", "aria-multiline", "true", "data-placeholder", "Ask a question", 1, "editor", 3, "keydown", "paste"], ["type", "submit", 1, "send-button", 3, "disabled"], [1, "avatar"], ["class", "bubble", 3, "innerHTML", 4, "ngIf"], ["class", "bubble", 4, "ngIf"], [1, "bubble", 3, "innerHTML"], [1, "bubble"]], template: function ChatComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "app-header");
      \u0275\u0275elementStart(1, "main", 2)(2, "section", 3)(3, "header", 4)(4, "div")(5, "h1");
      \u0275\u0275text(6, "AI Chat");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p");
      \u0275\u0275text(8);
      ...
      \u0275\u0275listener("click", function ChatComponent_Template_button_click_9_listener() {
        return ctx.chat.clearMessages();
      });
      \u0275\u0275text(10, "Clear");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "div", 6, 0);
      \u0275\u0275template(13, ChatComponent_article_13_Template, 5, 5, "article", 7);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "form", 8);
      \u0275\u0275listener("submit", function ChatComponent_Template_form_submit_14_listener($event) {
        return ctx.onSubmit($event);
      });
      \u0275\u0275elementStart(15, "div", 9)(16, "button", 10);
      \u0275\u0275listener("click", function ChatComponent_Template_button_click_16_listener() {
        return ctx.execCommand("bold");
      });
      \u0275\u0275elementStart(17, "b");
      \u0275\u0275text(18, "B");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function ChatComponent_Template_button_click_19_listener() {
        return ctx.execCommand("italic");
      });
      \u0275\u0275elementStart(20, "i");
      \u0275\u0275text(21, "I");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "button", 12);
      \u0275\u0275listener("click", function ChatComponent_Template_button_click_22_listener() {
        return ctx.execCommand("underline");
      });
      \u0275\u0275elementStart(23, "u");
      \u0275\u0275text(24, "U");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(25, "div", 13)(26, "div", 14, 1);
      \u0275\u0275listener("keydown", function ChatComponent_Template_div_keydown_26_listener($event) {
        return ctx.onKeyDown($event);
      })("paste", function ChatComponent_Template_div_paste_26_listener($event) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate(ctx.chat.connectionStatus());
      \u0275\u0275advance(5);
      \u0275\u0275property("ngForOf", ctx.chat.messages());
      \u0275\u0275advance(15);
      \u0275\u0275property("disabled", ctx.chat.isSending() || ctx.chat.connectionStatus() !== "Connected");
    }
  }, dependencies: [CommonModule, NgForOf, NgIf, HeaderComponent], styles: ["\n.app-shell[_ngcontent-%COMP%] {\n  min-height: 100vh;\n  display: grid;\n  place-items: center;\n  padding: 24px;\n  padding-top: 84px;\n}\n.chat-panel[_ngcontent-%COMP%] {\n  width: min(980px, 100%);\n  height: min(820px, calc(100vh - 48px));\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  background: #ffffff;\n  border: 1px solid #d8dee6;\n  border-radius: 8px;\n  box-shadow: 0 24px 70px rgba(31, 41, 51, 0.14);\n  overflow: hidden;\n}\n.chat-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 16px;\n  min-height: 74px;\n  padding: 16px 20px;\n  border-bottom: 1px solid #e5e9ef;\n  background: #fbfcfd;\n}\n.chat-header[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 20px;\n  line-height: 1.2;\n  font-weight: 700;\n}\n.chat-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 4px 0 0;\n  color: #5b6776;\n  font-size: 13px;\n}\n.ghost-button[_ngcontent-%COMP%], \n.send-button[_ngcontent-%COMP%] {\n  min-height: 40px;\n  border: 0;\n  border-radius: 6px;\n  cursor: pointer;\n  font-weight: 650;\n}\n.ghost-button[_ngcontent-%COMP%] {\n  padding: 0 14px;\n  color: #345;\n  background: #eef2f6;\n}\n.send-button[_ngcontent-%COMP%] {\n  width: 96px;\n  color: #fff;\n  background: #0f766e;\n}\n.send-button[_ngcontent-%COMP%]:disabled {\n  cursor: not-allowed;\n  opacity: 0.55;\n}\n.messages[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  padding: 20px;\n  overflow: auto;\n  background:\n    linear-gradient(\n      180deg,\n      #ffffff 0%,\n      #f7f9fb 100%);\n}\n.message[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 34px minmax(0, 1fr);\n  gap: 10px;\n  max-width: 82%;\n}\n.message.user[_ngcontent-%COMP%] {\n  align-self: end;\n  grid-template-columns: minmax(0, 1fr) 34px;\n}\n.avatar[_ngcontent-%COMP%] {\n  width: 34px;\n  height: 34px;\n  display: grid;\n  place-items: center;\n  border-radius: 50%;\n  background: #2f5d62;\n  color: #fff;\n  font-size: 12px;\n  font-weight: 800;\n}\n.message.user[_ngcontent-%COMP%]   .avatar[_ngcontent-%COMP%] {\n  grid-column: 2;\n  background: #a44a3f;\n}\n.bubble[_ngcontent-%COMP%] {\n  min-width: 0;\n  padding: 11px 13px;\n  border-radius: 8px;\n  background: #edf6f5;\n  color: #162a2a;\n  line-height: 1.48;\n  white-space: pre-wrap;\n  overflow-wrap: anywhere;\n}\n.bubble[_ngcontent-%COMP%]   b[_ngcontent-%COMP%], \n.bubble[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  font-weight: 700;\n}\n.bubble[_ngcontent-%COMP%]   i[_ngcontent-%COMP%], \n.bubble[_ngcontent-%COMP%]   em[_ngcontent-%COMP%] {\n  font-style: italic;\n}\n.bubble[_ngcontent-%COMP%]   u[_ngcontent-%COMP%] {\n  text-decoration: underline;\n}\n.message.user[_ngcontent-%COMP%]   .bubble[_ngcontent-%COMP%] {\n  grid-column: 1;\n  grid-row: 1;\n  background: #f8e8e4;\n  color: #321c19;\n}\n.message.error[_ngcontent-%COMP%]   .bubble[_ngcontent-%COMP%] {\n  background: #fff1f2;\n  color: #9f1239;\n}\n.composer-container[_ngcontent-%COMP%] {\n  border-top: 1px solid #e5e9ef;\n  background: #ffffff;\n}\n.toolbar[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 4px;\n  padding: 8px 16px;\n  border-bottom: 1px solid #f0f2f5;\n}\n.toolbar[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  width: 28px;\n  height: 28px;\n  padding: 0;\n  display: grid;\n  place-items: center;\n  background: transparent;\n  border: 1px solid transparent;\n  border-radius: 4px;\n  cursor: pointer;\n  color: #4b5563;\n}\n.toolbar[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover {\n  background: #f3f4f6;\n  border-color: #d1d5db;\n}\n.composer[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: minmax(0, 1fr) auto;\n  gap: 12px;\n  padding: 12px 16px 16px;\n}\n.editor[_ngcontent-%COMP%] {\n  min-height: 52px;\n  max-height: 170px;\n  overflow: auto;\n  padding: 14px;\n  border: 1px solid #cbd5df;\n  border-radius: 8px;\n  outline: none;\n  line-height: 1.45;\n  white-space: pre-wrap;\n}\n.editor[_ngcontent-%COMP%]:focus {\n  border-color: #0f766e;\n  box-shadow: 0 0 0 3px rgba(15, 118, 110, 0.16);\n}\n.editor[_ngcontent-%COMP%]:empty::before {\n  content: attr(data-placeholder);\n  color: #7b8794;\n}\n@media (max-width: 680px) {\n  .app-shell[_ngcontent-%COMP%] {\n    padding: 0;\n  }\n  .chat-panel[_ngcontent-%COMP%] {\n    height: 100vh;\n    border-radius: 0;\n    border: 0;\n  }\n  .message[_ngcontent-%COMP%] {\n    max-width: 100%;\n  }\n  .composer[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n  .send-button[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n}\n/*# sourceMappingURL=chat.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatComponent, [{
    type: Component,
    args: [{ selector: "app-chat", standalone: true, imports: [CommonModule, HeaderComponent], template: `<app-header></app-header>
...
<main class="app-shell">
    <section class="chat-panel" aria-label="AI chat">
        <header class="chat-header">
            ...
            <button (click)="chat.clearMessages()" class="ghost-button" type="button">Clear</button>
        </header>

        <div #messagesContainer class="messages" aria-live="polite">
            <article *ngFor="let msg of chat.messages()" [class]="'message ' + msg.kind">
                <div class="avatar">{{ msg.kind.startsWith('user') ? 'YOU' : 'AI' }}</div>
                <div class="bubble" *ngIf="msg.isHtml" [innerHTML]="msg.content"></div>
                <div class="bubble" *ngIf="!msg.isHtml">{{ msg.content }}</div>
            </article>
        </div>

        <form (submit)="onSubmit($event)" class="composer-container">
            <div class="toolbar">
            ...
            <div class="composer">
                ...
                <button [disabled]="chat.isSending() || chat.connectionStatus() !== 'Connected'" class="send-button" type="submit">Send</button>
            </div>
        </form>
    </section>
</main>
`, styles: ["/* src/app/components/chat/chat.component.css */\n.app-shell {\n  min-height: 100vh;\n  display: grid;\n  place-items: center;\n  padding: 24px;\n  padding-top: 84px;\n}\n.chat-panel {\n  width: min(980px, 100%);\n  height: min(820px, calc(100vh - 48px));\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  background: #ffffff;\n  border: 1px solid #d8dee6;\n  border-radius: 8px;\n  box-shadow: 0 24px 70px rgba(31, 41, 51, 0.14);\n  overflow: hidden;\n}\n.chat-header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 16px;\n  min-height: 74px;\n  padding: 16px 20px;\n  border-bottom: 1px solid #e5e9ef;\n  background: #fbfcfd;\n}\n.chat-header h1 {\n  margin: 0;\n  font-size: 20px;\n  line-height: 1.2;\n  font-weight: 700;\n}\n.chat-header p {\n  margin: 4px 0 0;\n  color: #5b6776;\n  font-size: 13px;\n}\n.ghost-button,\n.send-button {\n  min-height: 40px;\n  border: 0;\n  border-radius: 6px;\n  cursor: pointer;\n  font-weight: 650;\n}\n.ghost-button {\n  padding: 0 14px;\n  color: #345;\n  background: #eef2f6;\n}\n.send-button {\n  width: 96px;\n  color: #fff;\n  background: #0f766e;\n}\n.send-button:disabled {\n  cursor: not-allowed;\n  opacity: 0.55;\n}\n.messages {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  padding: 20px;\n  overflow: auto;\n  background:\n    linear-gradient(\n      180deg,\n      #ffffff 0%,\n      #f7f9fb 100%);\n}\n.message {\n  display: grid;\n  grid-template-columns: 34px minmax(0, 1fr);\n  gap: 10px;\n  max-width: 82%;\n}\n.message.user {\n  align-self: end;\n  grid-template-columns: minmax(0, 1fr) 34px;\n}\n.avatar {\n  width: 34px;\n  height: 34px;\n  display: grid;\n  place-items: center;\n  border-radius: 50%;\n  background: #2f5d62;\n  color: #fff;\n  font-size: 12px;\n  font-weight: 800;\n}\n.message.user .avatar {\n  grid-column: 2;\n  background: #a44a3f;\n}\n.bubble {\n  min-width: 0;\n  padding: 11px 13px;\n  border-radius: 8px;\n  background: #edf6f5;\n  color: #162a2a;\n  line-height: 1.48;\n  white-space: pre-wrap;\n  overflow-wrap: anywhere;\n}\n.bubble b,\n.bubble strong {\n  font-weight: 700;\n}\n.bubble i,\n.bubble em {\n  font-style: italic;\n}\n.bubble u {\n  text-decoration: underline;\n}\n.message.user .bubble {\n  grid-column: 1;\n  grid-row: 1;\n  background: #f8e8e4;\n  color: #321c19;\n}\n.message.error .bubble {\n  background: #fff1f2;\n  color: #9f1239;\n}\n.composer-container {\n  border-top: 1px solid #e5e9ef;\n  background: #ffffff;\n}\n.toolbar {\n  display: flex;\n  gap: 4px;\n  padding: 8px 16px;\n  border-bottom: 1px solid #f0f2f5;\n}\n.toolbar button {\n  width: 28px;\n  height: 28px;\n  padding: 0;\n  display: grid;\n  place-items: center;\n  background: transparent;\n  border: 1px solid transparent;\n  border-radius: 4px;\n  cursor: pointer;\n  color: #4b5563;\n}\n.toolbar button:hover {\n  background: #f3f4f6;\n  border-color: #d1d5db;\n}\n.composer {\n  display: grid;\n  grid-template-columns: minmax(0, 1fr) auto;\n  gap: 12px;\n  padding: 12px 16px 16px;\n}\n.editor {\n  min-height: 52px;\n  max-height: 170px;\n  overflow: auto;\n  padding: 14px;\n  border: 1px solid #cbd5df;\n  border-radius: 8px;\n  outline: none;\n  line-height: 1.45;\n  white-space: pre-wrap;\n}\n.editor:focus {\n  border-color: #0f766e;\n  box-shadow: 0 0 0 3px rgba(15, 118, 110, 0.16);\n}\n.editor:empty::before {\n  content: attr(data-placeholder);\n  color: #7b8794;\n}\n@media (max-width: 680px) {\n  .app-shell {\n    padding: 0;\n  }\n  .chat-panel {\n    height: 100vh;\n    border-radius: 0;\n    border: 0;\n  }\n  .message {\n    max-width: 100%;\n  }\n  .composer {\n    grid-template-columns: 1fr;\n  }\n  .send-button {\n    width: 100%;\n  }\n}\n/*# sourceMappingURL=chat.component.css.map */\n"] }]
  }], () => [], { editor: [{
    type: ViewChild,
    args: ["editor"]
  }], messagesContainer: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChatComponent, { className: "ChatComponent", filePath: "src/app/components/chat/chat.component.ts", lineNumber: 13 });
})();
export {
  ChatComponent
};
